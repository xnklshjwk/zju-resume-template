...
\begin{tikzpicture}[remember picture, overlay] 
  ...
  \begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north west] at ($(current page.north west)+(0.5cm,+1.0cm)$) {\includegraphics[height=2.5cm]{uestc.png}};
  \end{tikzpicture}%
\centerline{\LARGE\bfseries{杨烁}} 

\centerline{\normalsize{\faPhone\ 137-6723-7929 \quad \faEnvelopeO\ \href{mailto:13767237929@163.com}{13767237929@163.com}}} 

\centerline{\normalsize{\faGithubSquare\ \href{https://github.com/xnklshjwk}{https://github.com/xnklshjwk} \quad \faRssSquare\ \href{https://xnklshjwk.github.io/}{https://xnklshjwk.github.io}}} 
    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
\textbf{电子科技大学} \hfill 2023.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
CC98数学与应用数学\quad 大三 
\begin{itemize}[nosep]
    \item 相关课程：《泛函分析》:96分、《最优化方法》:94分、《数字图像处理》:97分
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{开发工具：} Git, LaTex, Pytorch
...
\begin{itemize}[parsep=0.5ex]
    ...
    \item \textbf{GitHub：} \href{https://github.com/xnklshjwk}{https://github.com/xnklshjwk} 
    \item \textbf{英语水平：} CET-4(585), CET-6(508)
\end{itemize}
\end{document}
